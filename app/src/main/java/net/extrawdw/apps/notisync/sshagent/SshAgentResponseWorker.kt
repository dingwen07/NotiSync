...
class SshAgentResponseWorker(context: Context, parameters: WorkerParameters) : CoroutineWorker(context, parameters) {
    override suspend fun doWork(): Result {
        ...
        val engine = graph.sshAgentProviderEngine ?: return Result.retry()
    ...
    companion object {
        ...
        fun enqueue(context: Context, requestId: String) {
            val request = OneTimeWorkRequestBuilder<SshAgentResponseWorker>()
