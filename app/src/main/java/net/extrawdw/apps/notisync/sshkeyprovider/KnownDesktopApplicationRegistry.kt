...
internal val BUILT_IN_DESKTOP_APPLICATIONS = KnownDesktopApplicationRegistry(
    listOf(
        ...
        knownDesktopApplication("wslhost", "WSL Host", DesktopApplicationProcessRole.ENVIRONMENT_HOST, "wslhost.exe"),

        lineageProcess("conhost", "Console Host", DesktopApplicationLineageTraversal.SKIP, "conhost.exe"),
        ...
        lineageProcess("explorer", "Windows Explorer", DesktopApplicationLineageTraversal.STOP, "explorer.exe"),
        lineageProcess("services", "Windows Services", DesktopApplicationLineageTraversal.STOP, "services.exe"),
        lineageProcess("svchost", "Windows Service Host", DesktopApplicationLineageTraversal.STOP, "svchost.exe"),
        lineageProcess("wininit", "Windows Start-Up", DesktopApplicationLineageTraversal.STOP, "wininit.exe"),
        lineageProcess("npiperelay", "npiperelay", DesktopApplicationLineageTraversal.STOP, "npiperelay.exe"),
