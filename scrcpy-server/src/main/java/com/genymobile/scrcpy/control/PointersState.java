...
public class PointersState {
    ...
    /** Returns an active pointer without creating one for an orphan MOVE/UP. */
    public int getActivePointerIndex(long id) {
        return indexOf(id);
    }

    /** Starts a pointer lifecycle. Only ACTION_DOWN callers may use this method. */
    public int getOrCreatePointerIndex(long id) {
